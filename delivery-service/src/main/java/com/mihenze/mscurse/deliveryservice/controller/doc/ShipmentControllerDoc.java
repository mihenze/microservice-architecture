...
import com.mihenze.mscurse.deliveryservice.rest.ShipmentErrorResponse;
...
@Tag(name = "Shipment Service API", description = "Сервис Доставки")
public interface ShipmentControllerDoc {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "Оплата не найдена",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            schema = @Schema(implementation = ShipmentErrorResponse.class))),
